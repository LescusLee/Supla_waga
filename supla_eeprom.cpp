...
void save_calibration_scale(String save) {
   
  int start = 1 + MAX_SSID + MAX_PASSWORD + MAX_MLOGIN + MAX_MPASSWORD + MAX_SUPLA_SERVER + MAX_SUPLA_ID + MAX_SUPLA_PASS + MAX_HOSTNAME + (SUPLA_GUID_SIZE * 2) + MAX_BUTTON + MAX_RELAY + (MAX_DS18B20_SIZE * (MAX_DS18B20 + 1));
  int koniec = start + MAX_CALIBRATION;
  int len = save.length();
  EEPROM.begin(EEPROM_SIZE);
  delay(100);
...
String read_calibration_scale(void) {
...
void save_empty_bottle(String save) {
   
  int start = 1 + MAX_SSID + MAX_PASSWORD + MAX_MLOGIN + MAX_MPASSWORD + MAX_SUPLA_SERVER + MAX_SUPLA_ID + MAX_SUPLA_PASS + MAX_HOSTNAME + (SUPLA_GUID_SIZE * 2) + MAX_BUTTON + MAX_RELAY + (MAX_DS18B20_SIZE * (MAX_DS18B20 + 1)) + MAX_CALIBRATION;
  int koniec = start + sizeof(butla_pusta);
  int len = save.length();
  EEPROM.begin(EEPROM_SIZE);
  delay(100);
...
String read_empty_bottle(void) {
  
  String read_eeprom = "";
  
  int start = 1 + MAX_SSID + MAX_PASSWORD + MAX_MLOGIN + MAX_MPASSWORD + MAX_SUPLA_SERVER + MAX_SUPLA_ID + MAX_SUPLA_PASS + MAX_HOSTNAME + (SUPLA_GUID_SIZE * 2) + MAX_BUTTON + MAX_RELAY + (MAX_DS18B20_SIZE * (MAX_DS18B20 + 1))+ MAX_CALIBRATION;
  int koniec = start + sizeof(butla_pusta);//extern double butla_pusta;
